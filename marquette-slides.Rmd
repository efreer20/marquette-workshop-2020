...
##########Need to add more specific instructions here


######### for the next sections, need to add visuals of the RStudio panes
...
# Hi, RStudio: Data & the Environment
  ...
  -  Try loading some data into the working environment.
...
```{r, eval = FALSE}
#Sample code:
averageGradeData <- data %>%   #Take grade data called "data" and save it as "averageGradeData"
 group_by(Last, course_sem) %>%  #Then, group by course and semester
  summarize(avgGrade = mean(`Grd Pt/Unt`, na.rm = TRUE)) %>% 
                  ...
                  #in this new column, take the average of all the grades (within a
                  #course/semester)
  view #then show me the result
```
---
# Code with me: Putting it all together

####### Some lovely example that synthesizes everything using the practice data
---
...
---
# Code with me: Working directory
