...
#do not run student_data <- student_data %>% select(var1, var2, var3)
...
########################################Finish this with what I need to do to load the data
...
```{r}
# data %>% 
#  # INSERT SELECT COMMANDS MAYBE
# # INSERT MUTATE COMMANDS MAYBE  
